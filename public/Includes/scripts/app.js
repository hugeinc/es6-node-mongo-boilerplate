...
var _$ = require('./lib/jquery-1.11.2.min');

var _$2 = _interopRequireWildcard(_$);

var _ModuleLoader = require('./modules/ModuleLoader.es6');

var _ModuleLoader2 = _interopRequireWildcard(_ModuleLoader);

var _Utils = require('./modules/Utils.es6');

var _Utils2 = _interopRequireWildcard(_Utils);

var _Sample = require('./modules/Sample.es6');

var _Sample2 = _interopRequireWildcard(_Sample);

var app = new _ModuleLoader2['default'](_$2['default'], _Utils2['default'], [_Sample2['default']], _$2['default']('[data-module]'));
...
},{"./lib/jquery-1.11.2.min":2,"./modules/ModuleLoader.es6":4,"./modules/Sample.es6":5,"./modules/Utils.es6":6}],2:[function(require,module,exports){
...
var ModuleLoader = (function () {
    function ModuleLoader($, Utils, imports, views) {
        ...
        this.instantiateModules = function (modules) {
            var _modulesOnPage = getModulesOnPage(),
                _module = undefined,
                _name = undefined,
                _loaded = [];
            ...
            for (var i = 0; i < modules.length; i++) {
                ...
                if (_modulesOnPage.indexOf(_name) > -1 && _loaded.indexOf(_name) === -1) {
...
var _Promise = require('../lib/promise.min');
...
var Utils = (function () {
  function Utils() {
    ...
    this.loadUrl = function (url, method, params, json, callback) {
      return new _Promise2['default'].Promise(function (resolve, reject) {
